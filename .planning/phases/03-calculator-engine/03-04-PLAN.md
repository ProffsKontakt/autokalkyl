...
<task type="auto">
  <name>Task 3: Create comparison view and results step</name>
...
```
  ...
  <done>Comparison view and results step compile; results display calculates ROI using engine and shows charts/comparison</done>
</task>
...
- Results step calculates using calculateBatteryROI engine
