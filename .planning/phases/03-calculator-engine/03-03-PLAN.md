...
```
  ...
  <done>Wizard container and navigation compile; page fetches natagare, batteries, and prices for the wizard</done>
</task>
...
export function ResultsStep({ quarterlyPrices, orgSettings }: ResultsStepProps) {
  return (
    <div className="max-w-4xl mx-auto">
...
```
  ...
  <done>Consumption simulator with Recharts bar chart, monthly tabs, presets, and scaling compiles; placeholder steps for battery and results created</done>
</task>
