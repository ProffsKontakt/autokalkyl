# Requirements Archive: v1.2 Realistic Consumption & Peak Tariffs
...
- [x] **FIX-01**: Spotpris efficiency displays correctly (90.2% not 90000.2%)
- [x] **FIX-02**: Super Admin sidebar menu is permanent (not hover-triggered)
- [x] **FIX-03**: Hardcoded currentPeakKw values are centralized and use customer input
- [x] **FIX-04**: Spotpris breakdown displays correctly (verkningsgrad as %, daglig energi/besparing with correct values)
